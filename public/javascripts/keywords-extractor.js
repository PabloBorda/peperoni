...
},{"./stopwords/stopwords":11,"underscore":13,"underscore.string":12}],3:[function(require,module,exports){
/**
...
},{"./de":3,"./en":4,"./es":5,"./fr":6,"./it":7,"./nl":8,"./pl":9,"./ru":10}],12:[function(require,module,exports){
//  Underscore.string
...
function extract_keywords_from(text){
  ...
  if ((extraction_result.length==0) || (extraction_result.length<5)){
    extraction_result = text.split(" ");
  }
